            ...
            react_1["default"].createElement("div", { className: Footer_module_scss_1["default"].content },
                ...
                react_1["default"].createElement("div", { className: Footer_module_scss_1["default"]['content__right'] },
                    react_1["default"].createElement("div", { className: Footer_module_scss_1["default"]['content__right__nav'] },
                        react_1["default"].createElement(react_router_dom_1.Link, { to: '/', className: Footer_module_scss_1["default"]['item'] },
                            react_1["default"].createElement("span", null, "HOME")),
                        react_1["default"].createElement(react_router_dom_1.Link, { to: '/categories/1', className: Footer_module_scss_1["default"]['item'] },
                            react_1["default"].createElement("span", null, "HEADPHONES")),
                        react_1["default"].createElement(react_router_dom_1.Link, { to: '/categories/2', className: Footer_module_scss_1["default"]['item'] },
                            react_1["default"].createElement("span", null, "SPEAKERS")),
                        react_1["default"].createElement(react_router_dom_1.Link, { to: '/categories/3', className: Footer_module_scss_1["default"]['item'] },
