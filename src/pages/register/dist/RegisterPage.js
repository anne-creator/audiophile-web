...
var RegisterPage_module_scss_1 = require("./RegisterPage.module.scss");
...
exports.RegisterPage = function () {
    ...
    var onFinish = function (values) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios_1["default"].post("http://123.56.149.216:8080/auth/register", {
    ...
    return (react_1["default"].createElement(userLayout_1.UserLayout, null,
        react_1["default"].createElement("div", null,
            react_1["default"].createElement("h1", { className: RegisterPage_module_scss_1["default"]['register__title'] }, "Register"),
            react_1["default"].createElement(antd_1.Form, __assign({}, layout, { name: "basic", initialValues: { remember: true }, onFinish: onFinish, onFinishFailed: onFinishFailed, className: RegisterPage_module_scss_1["default"]["register-form"] }),
                ...
                react_1["default"].createElement(antd_1.Form.Item, { label: "Confirm Password", name: "confirm", hasFeedback: true, rules: [
                ...
                react_1["default"].createElement(antd_1.Form.Item, __assign({}, tailLayout),
                    react_1["default"].createElement(antd_1.Button, { type: "primary", htmlType: "submit", className: RegisterPage_module_scss_1["default"]['button-primary'] }, "Submit"))))));
};
